...
{
HX_STACK_FRAME("com.ukuleledog.games.vibol.levels.Level4","new",0x426dc49c,"com.ukuleledog.games.vibol.levels.Level4.new","com/ukuleledog/games/vibol/levels/Level4.hx",44,0xe15c7295)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(45)
	super::__construct();
	...
	this->block1 = _g3;
	HX_STACK_LINE(60)
	this->addElement(this->block1,(int)6,(int)19);
	HX_STACK_LINE(62)
	::com::ukuleledog::games::vibol::elements::Block _g4 = ::com::ukuleledog::games::vibol::elements::Block_obj::__new(null(),null());		HX_STACK_VAR(_g4,"_g4");
	HX_STACK_LINE(62)
	this->block2 = _g4;
	HX_STACK_LINE(63)
	this->addElement(this->block2,(int)6,(int)22);
	HX_STACK_LINE(65)
	...
	this->block3 = _g5;
	HX_STACK_LINE(66)
	this->addElement(this->block3,(int)6,(int)26);
	HX_STACK_LINE(68)
	::com::ukuleledog::games::vibol::elements::Block _g6 = ::com::ukuleledog::games::vibol::elements::Block_obj::__new(null(),null());		HX_STACK_VAR(_g6,"_g6");
	HX_STACK_LINE(68)
	this->block4 = _g6;
	HX_STACK_LINE(69)
	this->addElement(this->block4,(int)5,(int)31);
	HX_STACK_LINE(71)
	::com::ukuleledog::games::vibol::elements::Block _g7 = ::com::ukuleledog::games::vibol::elements::Block_obj::__new(null(),null());		HX_STACK_VAR(_g7,"_g7");
	HX_STACK_LINE(71)
	this->block5 = _g7;
	HX_STACK_LINE(72)
	this->addElement(this->block5,(int)4,(int)36);
	HX_STACK_LINE(74)
	::com::ukuleledog::games::vibol::elements::LongBlock _g8 = ::com::ukuleledog::games::vibol::elements::LongBlock_obj::__new((int)2,null());		HX_STACK_VAR(_g8,"_g8");
	HX_STACK_LINE(74)
	this->block6 = _g8;
	HX_STACK_LINE(75)
	this->addElement(this->block6,(int)4,(int)39);
	HX_STACK_LINE(77)
	::com::ukuleledog::games::vibol::elements::Block _g9 = ::com::ukuleledog::games::vibol::elements::Block_obj::__new(null(),null());		HX_STACK_VAR(_g9,"_g9");
	HX_STACK_LINE(77)
	this->block7 = _g9;
	HX_STACK_LINE(78)
	this->addElement(this->block7,(int)4,(int)44);
	HX_STACK_LINE(79)
	this->block7->setMoving((int)5,(int)44,(int)1);
	HX_STACK_LINE(81)
	::com::ukuleledog::games::vibol::elements::Block _g10 = ::com::ukuleledog::games::vibol::elements::Block_obj::__new(null(),null());		HX_STACK_VAR(_g10,"_g10");
	HX_STACK_LINE(81)
	this->block8 = _g10;
	HX_STACK_LINE(82)
	this->addElement(this->block8,(int)4,(int)47);
	HX_STACK_LINE(83)
	this->block8->setMoving((int)5,(int)47,(int)10);
	HX_STACK_LINE(85)
	::com::ukuleledog::games::vibol::elements::LongBlock _g11 = ::com::ukuleledog::games::vibol::elements::LongBlock_obj::__new((int)17,null());		HX_STACK_VAR(_g11,"_g11");
	HX_STACK_LINE(85)
	this->floor2 = _g11;
	HX_STACK_LINE(86)
	this->addElement(this->floor2,(int)7,(int)50);
	HX_STACK_LINE(88)
	::com::ukuleledog::games::vibol::enemies::Orc _g12 = ::com::ukuleledog::games::vibol::enemies::Orc_obj::__new();		HX_STACK_VAR(_g12,"_g12");
	HX_STACK_LINE(88)
	this->orc1 = _g12;
	HX_STACK_LINE(89)
	this->addEnnemy(this->orc1,(int)6,(int)55);
	HX_STACK_LINE(90)
	this->orc1->setRoaming((int)1,null());
	HX_STACK_LINE(92)
	::com::ukuleledog::games::vibol::enemies::Frog _g13 = ::com::ukuleledog::games::vibol::enemies::Frog_obj::__new(false);		HX_STACK_VAR(_g13,"_g13");
	HX_STACK_LINE(92)
	this->frog5 = _g13;
	HX_STACK_LINE(93)
	this->addEnnemy(this->frog5,(int)3,(int)40);
	HX_STACK_LINE(95)
	::com::ukuleledog::games::vibol::elements::Teleport _g14 = ::com::ukuleledog::games::vibol::elements::Teleport_obj::__new();		HX_STACK_VAR(_g14,"_g14");
	HX_STACK_LINE(95)
	this->endTeleport = _g14;
	HX_STACK_LINE(96)
	this->endTeleport->set_y((int)320);
	HX_STACK_LINE(97)
	this->endTeleport->set_x((int)4096);
	HX_STACK_LINE(98)
	this->addChild(this->endTeleport);
	HX_STACK_LINE(100)
	::openfl::_v2::geom::Point _g15 = ::openfl::_v2::geom::Point_obj::__new((int)1,(int)6);		HX_STACK_VAR(_g15,"_g15");
	HX_STACK_LINE(100)
	this->startingPosition = _g15;
	HX_STACK_LINE(101)
	::com::ukuleledog::games::vibol::elements::Vibol _g16 = ::com::ukuleledog::games::vibol::elements::Vibol_obj::__new();		HX_STACK_VAR(_g16,"_g16");
	HX_STACK_LINE(101)
	this->setHero(_g16);
	HX_STACK_LINE(103)
	::openfl::_v2::display::BitmapData thing = ::openfl::_v2::Assets_obj::getBitmapData(HX_CSTRING("img/background4.png"),null());		HX_STACK_VAR(thing,"thing");
	HX_STACK_LINE(104)
	this->get_graphics()->beginBitmapFill(thing,null(),null(),null());
	HX_STACK_LINE(105)
	int _g17 = thing->get_width();		HX_STACK_VAR(_g17,"_g17");
	HX_STACK_LINE(105)
	this->get_graphics()->drawRect((int)0,(int)0,_g17,(int)514);
	HX_STACK_LINE(106)
...
void Level4_obj::__Mark(HX_MARK_PARAMS)
{
	HX_MARK_BEGIN_CLASS(Level4);
...
void Level4_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(frog5,"frog5");
...
Dynamic Level4_obj::__Field(const ::String &inName,bool inCallProp)
{
	...
	case 5:
		...
		if (HX_FIELD_EQ(inName,"frog5") ) { return frog5; }
		break;
	case 6:
...
Dynamic Level4_obj::__SetField(const ::String &inName,const Dynamic &inValue,bool inCallProp)
{
	...
	case 5:
		...
		if (HX_FIELD_EQ(inName,"frog5") ) { frog5=inValue.Cast< ::com::ukuleledog::games::vibol::enemies::Frog >(); return inValue; }
		break;
	case 6:
		...
		if (HX_FIELD_EQ(inName,"block6") ) { block6=inValue.Cast< ::com::ukuleledog::games::vibol::elements::LongBlock >(); return inValue; }
...
void Level4_obj::__GetFields(Array< ::String> &outFields)
{
	...
	outFields->push(HX_CSTRING("frog5"));
...
static hx::StorageInfo sMemberStorageInfo[] = {
	{hx::fsObject /*::com::ukuleledog::games::vibol::elements::LongBlock*/ ,(int)offsetof(Level4_obj,floor1),HX_CSTRING("floor1")},
	{hx::fsObject /*::com::ukuleledog::games::vibol::enemies::Frog*/ ,(int)offsetof(Level4_obj,frog1),HX_CSTRING("frog1")},
	{hx::fsObject /*::com::ukuleledog::games::vibol::enemies::Frog*/ ,(int)offsetof(Level4_obj,frog2),HX_CSTRING("frog2")},
	{hx::fsObject /*::com::ukuleledog::games::vibol::elements::Block*/ ,(int)offsetof(Level4_obj,block1),HX_CSTRING("block1")},
	{hx::fsObject /*::com::ukuleledog::games::vibol::elements::Block*/ ,(int)offsetof(Level4_obj,block2),HX_CSTRING("block2")},
	{hx::fsObject /*::com::ukuleledog::games::vibol::elements::Block*/ ,(int)offsetof(Level4_obj,block3),HX_CSTRING("block3")},
	{hx::fsObject /*::com::ukuleledog::games::vibol::elements::Block*/ ,(int)offsetof(Level4_obj,block4),HX_CSTRING("block4")},
	{hx::fsObject /*::com::ukuleledog::games::vibol::elements::Block*/ ,(int)offsetof(Level4_obj,block5),HX_CSTRING("block5")},
	{hx::fsObject /*::com::ukuleledog::games::vibol::elements::LongBlock*/ ,(int)offsetof(Level4_obj,block6),HX_CSTRING("block6")},
	{hx::fsObject /*::com::ukuleledog::games::vibol::elements::Block*/ ,(int)offsetof(Level4_obj,block7),HX_CSTRING("block7")},
	{hx::fsObject /*::com::ukuleledog::games::vibol::elements::Block*/ ,(int)offsetof(Level4_obj,block8),HX_CSTRING("block8")},
	{hx::fsObject /*::com::ukuleledog::games::vibol::elements::LongBlock*/ ,(int)offsetof(Level4_obj,floor2),HX_CSTRING("floor2")},
	{hx::fsObject /*::com::ukuleledog::games::vibol::enemies::Frog*/ ,(int)offsetof(Level4_obj,frog3),HX_CSTRING("frog3")},
	{hx::fsObject /*::com::ukuleledog::games::vibol::enemies::Frog*/ ,(int)offsetof(Level4_obj,frog4),HX_CSTRING("frog4")},
	{hx::fsObject /*::com::ukuleledog::games::vibol::enemies::Frog*/ ,(int)offsetof(Level4_obj,frog5),HX_CSTRING("frog5")},
	{hx::fsObject /*::com::ukuleledog::games::vibol::enemies::Orc*/ ,(int)offsetof(Level4_obj,orc1),HX_CSTRING("orc1")},
	{ hx::fsUnknown, 0, null()}
};
#endif
...
{
	hx::Static(__mClass) = hx::RegisterClass(HX_CSTRING("com.ukuleledog.games.vibol.levels.Level4"), hx::TCanCast< Level4_obj> ,sStaticFields,sMemberFields,
