...
#define INCLUDED_com_ukuleledog_games_vibol_levels_Level4
...
HX_DECLARE_CLASS5(com,ukuleledog,games,vibol,levels,Level4)
...
class HXCPP_CLASS_ATTRIBUTES  Level4_obj : public ::com::ukuleledog::games::vibol::levels::VibolLevel_obj{
	public:
	...
	public:
		...
		::com::ukuleledog::games::vibol::elements::LongBlock block6;
		...
		::com::ukuleledog::games::vibol::enemies::Frog frog5;
...
#endif /* INCLUDED_com_ukuleledog_games_vibol_levels_Level4 */ 
