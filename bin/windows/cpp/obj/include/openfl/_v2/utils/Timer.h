...
#define INCLUDED_openfl__v2_utils_Timer
...
class HXCPP_CLASS_ATTRIBUTES  Timer_obj : public ::openfl::_v2::events::EventDispatcher_obj{
	public:
...
#endif /* INCLUDED_openfl__v2_utils_Timer */ 
