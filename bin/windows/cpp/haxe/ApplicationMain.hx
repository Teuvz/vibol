...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("Matt", "vibol", "com.ukuleledog.games.vibol.vibol", "1.0.0");
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "vibol", null, { width: 514, height: 514 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 514, height: 514 });
			#end
			...
			if (hasMain) {
				...
				var instance = Type.createInstance (com.ukuleledog.games.vibol.Main, []);
			}
...
import com.ukuleledog.games.vibol.Main;
